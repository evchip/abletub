...
class ConfigurationLoader {
    ...
    static async registerTsNode(configPath = 'tsconfig.json') {
        ...
        const { options: configOptions } = Utils_1.Utils.requireFrom('ts-node', tsConfigPath).register({
            project: tsConfigPath,
            transpileOnly: true,
        }).config;
        if (Object.entries((_a = configOptions === null || configOptions === void 0 ? void 0 : configOptions.paths) !== null && _a !== void 0 ? _a : {}).length > 0) {
