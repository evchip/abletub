...
let PostResolver = class PostResolver {
    ...
    createPost(title, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const post = em.create(Post_1._Post, { title });
    ...
    updatePost(id, title, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const post = yield em.findOne(Post_1._Post, { id });
            if (!post) {
                return null;
            }
    ...
    deletePost(id, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield em.nativeDelete(Post_1._Post, { id });
            return true;
        });
    }
};
__decorate([
    type_graphql_1.Query(() => [Post_1._Post]),
